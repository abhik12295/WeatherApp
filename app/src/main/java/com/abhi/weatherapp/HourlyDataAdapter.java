...
public class HourlyDataAdapter extends RecyclerView.Adapter<HourlyDataViewHolder> {
    ...
    public HourlyDataAdapter(List<HourlyData> hourlyData, MainActivity mActivity) {
    ...
    public void onBindViewHolder(@NonNull HourlyDataViewHolder holder, int position) {
        ...
        holder.imgWeather.setImageResource(mainActivity.getResources().getIdentifier(hourlyWeather.icon, "drawable", "com.abhi.weatherapp"));
