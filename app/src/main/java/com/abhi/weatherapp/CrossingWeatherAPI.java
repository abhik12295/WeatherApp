...
public class CrossingWeatherAPI implements Runnable{
    ...
    private static final String url_weather = "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/";
    private static final String api_weather = "B9QMT3VFBBSL38MHFXHQXJPGH";
    private final boolean f;
    private MainActivity mActivity;
    private static String location;

    public CrossingWeatherAPI(MainActivity mActivity, boolean fahrenheit, String loc){
    ...
    @Override
    public void run() {
        Uri.Builder buildURL = Uri.parse(url_weather).buildUpon();
        buildURL.appendPath(String.valueOf(location));
        buildURL.appendQueryParameter("unitGroup", (f ? "us" : "metric"));
        buildURL.appendQueryParameter("lang","en");
        buildURL.appendQueryParameter("key", api_weather);
        ...
        Response.ErrorListener error =
                error1 -> mActivity.updateData(null,null);
    ...
    private void parseJSON(String str) {
        try {
            ...
            mActivity.runOnUiThread(() -> mActivity.updateData(weather,str));
